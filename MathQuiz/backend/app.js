...
router.route('/student/:id/quizzes/addition')
      .get(function(req, res) {
          let quizObject = {
              id        : req.params.id,
        ...
        studentService.getAdditionQuizzes(quizObject,function(result){
            res.json(result);
        });
      });

router.route('/student/:id/quizzes/subtraction')
      .get(function(req, res) {
          let quizObject = {
              id        : req.params.id,
              level     : req.query.level,
        ...
        studentService.getSubtractionQuizzes(quizObject,function(result){
            res.json(result);
        });
      });

router.route('/student/:id/quizzes/multiplication')
      .get(function(req, res) {
          let quizObject = {
              id        : req.params.id,
              level     : req.query.level,
        ...
        studentService.getMultiplicationQuizzes(quizObject,function(result){
            res.json(result);
        });
      });

router.route('/student/:id/quizzes/division')
      .get(function(req, res) {
          let quizObject = {
              id        : req.params.id,
              level     : req.query.level,
        ...
        studentService.getDivisionQuizzes(quizObject,function(result){
            res.json(result);
        });
      });
...
router.route('/student/:id/answers')
      .put(function(req, res) {
        ...
        let answers = {
            ...
            q4Answer      : req.body.q5Answer,
            q5Answer      : req.body.q5Answer,

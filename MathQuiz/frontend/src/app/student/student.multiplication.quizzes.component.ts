        ...
        <div class="container-fluid">
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6 col-sm-offset-3">
                    <h3 class="text-center">Quizzes for Multiplication</h3>
                </div>
            </div>
...
export class StudentMultiplicationQuizzesComponent implements OnInit {
    ...
    constructor(private studentService: StudentService,
                ...
                if(this.studentService.student)
                    ...
                    this.getMultiplicationQuizzes();      
    }

    getMultiplicationQuizzes() {
        this.studentService
            .getMultiplicationQuizzes(this.student)
            .subscribe(quizzes => {
                if(quizzes.length !=0) {
                    this.message= "Below is a list of quizzes for multiplication that needs to be completed";
                    this.quizzes = quizzes
                }
                else{
                    this.message= "you have no remaining quizzes for Multiplication :) !! check out quizzes for other operator :)";
                }

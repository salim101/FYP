    ...
    template: `
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-sm-offset-3">
                    Please answer each of the quiz questions
                </div>  
            </div>
...
export class StudentQuizComponent implements OnInit {
    ...
    submitAns(answer) {
        this.answers.answers(this.quizID,this.student.id,answer.q1,answer.q2,answer.q3,answer.q4,answer.q5,this.answers.dateAnswered = new Date().toLocaleString(),this.answeredTime);

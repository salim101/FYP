        ...
        <div class="container-fluid">
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6 col-sm-offset-3">
                    <h3 class="text-center">Quizzes for Subtraction</h3>
                </div>
            </div>
...
export class StudentSubtractionQuizzesComponent implements OnInit {
    ...
    constructor(private studentService: StudentService,
                ...
                if(this.studentService.student)
                    ...
                    this.getSubtractionQuizzes();      
    }

    getSubtractionQuizzes() {
        this.studentService
            .getSubtractionQuizzes(this.student)
            .subscribe(quizzes => {
                if(quizzes.length !=0) {
                    this.message= "Below is a list of quizzes for subtraction that needs to be completed";
                    this.quizzes = quizzes
                }
                else{
                    this.message= "you have no remaining quizzes for subtraction :) !! check out quizzes for other operator :)";
                }

                ...
                <div *ngIf="studentDetails" class="col-xs-12 col-md-8">
                    <form>
                        ...
                        <div class="form-group col-xs-12 col-md-6">
                            ...
                            <input type="text" [disabled]="true" class="form-control" placeholder="Student FirstName" value="{{students[indx].firstName}}" > 
                        </div>

                        <div class="form-group col-xs-12 col-md-6">
                            <label>LastName:</label>
                            <input type="text" [disabled]="true" class="form-control" placeholder="Student LastName" value="{{students[indx].lastName}}"> 
                        </div>

                        <div class="form-group col-xs-12 col-md-6">
                            <label>Level:</label>
                            <input type="text" [disabled]="true" class="form-control" placeholder="Student Level" value="{{students[indx].level}}"> 
                        </div>

                        <div class="form-group col-xs-12 col-md-6">
                            <label>Userrname:</label>
                            <input type="text" [disabled]="true" class="form-control" placeholder="Student Level" value="{{students[indx].username}}"> 
                        </div>

                        <div class="form-group col-xs-12 col-md-6">
                            <label>Password:</label>
                            <input type="text" [disabled]="true" class="form-control" placeholder="Student Level" value="{{students[indx].password}}"> 
                        </div>
